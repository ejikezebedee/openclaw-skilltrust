...
POLICY_PACKS: dict[str, PolicyPack] = {
    "baseline": PolicyPack(
        ...
        review_capabilities=("filesystem", "network", "browser", "memory", "messaging", "scheduler"),
    ...
    "mcp-tools": PolicyPack(
        ...
        review_capabilities=("filesystem", "network", "browser", "memory", "messaging"),
        gated_capabilities=("shell", "credentials", "deployment", "payment"),
        block_rules=("ST001", "ST003", "ST006"),
    ),
    "skills": PolicyPack(
        ...
        review_capabilities=("filesystem", "network", "browser", "memory"),
    ...
    "plugins": PolicyPack(
        ...
        review_capabilities=("filesystem", "network", "browser", "scheduler"),
    ...
    "repo-hygiene": PolicyPack(
        ...
        review_capabilities=("filesystem", "network"),
